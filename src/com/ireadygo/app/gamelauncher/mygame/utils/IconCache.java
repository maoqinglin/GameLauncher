...
import com.ireadygo.app.gamelauncher.mygame.data.GameLauncherModel;
import com.ireadygo.app.gamelauncher.mygame.info.AppInfo;
...
public class IconCache {
	...
	private CacheEntry cacheLocked(ComponentName componentName, ResolveInfo info,
		...
		if (entry == null) {
			...
			ComponentName key = GameLauncherModel.getComponentNameFromResolveInfo(info);
			...
			entry.icon = GameLauncherAppState.getInstance(mContext).getIconDecorater().decorateIcon(info);
			// }else{
