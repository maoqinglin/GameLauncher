...
public class FolderInfo extends ItemInfo {
    ...
    public FolderInfo() {
        itemType = GameLauncherSettings.Favorites.ITEM_TYPE_FOLDER; 
    }
    ...
    public void onAddToDatabase(ContentValues values) {
        ...
        values.put(GameLauncherSettings.Favorites.TITLE, title.toString());
    }
	...
	public String toString() {
		return "FolderInfo [opened=" + opened + ", contents=" + contents + ", listeners=" + listeners + "]";
	}
}
