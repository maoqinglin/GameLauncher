...
import com.ireadygo.app.gamelauncher.mygame.utils.DeferredHandler;
    ...
    public void addCallback(Callbacks callback) {
        ...
        synchronized (mLock) {
            ...
            for (Callbacks existCall : mCallbacks) {
                if (existCall instanceof MyAppFragment && callback instanceof MyAppFragment) {
                    tmpCallback = existCall;
                    break;
                }
                if (existCall instanceof MyGameFragment && callback instanceof MyGameFragment) {
                    tmpCallback = existCall;
                    break;
                }
            }
