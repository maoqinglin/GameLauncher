...
package com.ireadygo.app.gamelauncher.mygame.data;
 ...
 */
public class GameLauncherSettings {
    ...
    public static interface BaseLauncherColumns extends ChangeLogColumns {
        ...
        static final String CELL_SORT_ID = "cellSortId";
    ...
    public static final class Favorites implements BaseLauncherColumns {
        ...
        public static final Uri CONTENT_URI = Uri.parse("content://" +
                GameLauncherProvider.AUTHORITY + "/" + GameLauncherProvider.TABLE_FAVORITES +
                "?" + GameLauncherProvider.PARAMETER_NOTIFY + "=true");
        ...
        public static final Uri CONTENT_URI_NO_NOTIFICATION = Uri.parse("content://" +
                GameLauncherProvider.AUTHORITY + "/" + GameLauncherProvider.TABLE_FAVORITES +
                "?" + GameLauncherProvider.PARAMETER_NOTIFY + "=false");
        ...
        public static Uri getContentUri(long id, boolean notify) {
            return Uri.parse("content://" + GameLauncherProvider.AUTHORITY +
                    "/" + GameLauncherProvider.TABLE_FAVORITES + "/" + id + "?" +
                    GameLauncherProvider.PARAMETER_NOTIFY + "=" + notify);
        }
        ...
        */
        ...
        public static final int DONOT_DISPLAY = 1;
        ...
        public static final int APP_TYPE_APPLICATION= 0;
