...
public class CollectionLayout extends StoreBaseContentLayout {
	...
	public CollectionLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	public CollectionLayout(Context context, int layoutTag, StoreDetailActivity storeFragment) {
	...
	protected void init() {
		...
		initData();
		mAdapter = new CollectionAdapter(mAppList, mAppListView, getContext());
