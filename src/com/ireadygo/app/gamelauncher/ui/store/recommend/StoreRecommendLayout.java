...
public class StoreRecommendLayout extends StoreBaseContentLayout {
	...
	public StoreRecommendLayout(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		mContext = context;
	}

	public StoreRecommendLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
	}

	public StoreRecommendLayout(Context context, int layoutTag, StoreDetailActivity storeFragment) {
	...
	OnItemClickListener mOnItemClickListener = new OnItemClickListener(){
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			...
			bundle.putParcelable(GameDetailActivity.EXTRAS_APP_ENTITY, entity);
