...
public class StoreManageAdapter extends HExpandableListAdapter {
    ...
    public StoreManageAdapter(Context context, ExpandableHListView listview, List<AppEntity> downloadingList,
...
//		}
    ...
    public void openGameDetail(final AppEntity appEntity) {
        ...
        bundle.putParcelable(DetailActivity.EXTRAS_APP_ENTITY, appEntity);
