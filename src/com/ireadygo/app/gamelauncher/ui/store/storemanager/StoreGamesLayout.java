...
import com.ireadygo.app.gamelauncher.ui.store.storemanager.StoreManageAdapter.DldManagerViewHolder;
import com.ireadygo.app.gamelauncher.ui.store.storemanager.StoreManageAdapter.OnDataRefreshListener;
import com.ireadygo.app.gamelauncher.ui.store.storemanager.StoreManageAdapter.UpdateType;
...
public class StoreGamesLayout extends StoreBaseContentLayout {
	...
	private void initExpandList() {
		...
		mAdapter = new StoreManageAdapter(mContext, mStoreGameManagerExpandList, downloadingList, updatableList,
				launchableList);
