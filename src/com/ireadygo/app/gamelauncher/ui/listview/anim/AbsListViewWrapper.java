...
//    private final AbsListView mAbsListView;
    private final AbsHListView mAbsListView;

//    public AbsListViewWrapper( final AbsListView absListView) {
//        mAbsListView = absListView;
//    }

    public AbsListViewWrapper( final AbsHListView absListView) {
        mAbsListView = absListView;
    }
//    @Override
...
//    }
    @Override
    public AbsHListView getListView() {
        return mAbsListView;
    }
...
//    }
    ...
    public int getHeaderViewsCount() {
        int result = 0;
        if (mAbsListView instanceof HListView) {
            result = ((HListView) mAbsListView).getHeaderViewsCount();
        }
        return result;
    }
