...
public class SettingsMultiAdapterTest implements HMultiBaseAdapter {
	...
	public SettingsMultiAdapterTest(Context context,List<SettingsItemEntity> list,int listViewNum,HMultiListView hListViews) {
		mContext = context;
		mDataList = list;
