...
import com.ireadygo.app.gamelauncher.ui.gamecommunity.GameCommunityFragment.GameCommunityPoster;
import com.ireadygo.app.gamelauncher.ui.widget.HListView;

public class GameCommunityAdapter extends BaseAnimatorAdapter {

	private LayoutInflater mInflater;
	private List<GameCommunityPoster> mGameCommunityPosters;

	public GameCommunityAdapter(Context context, HListView hListView, List<GameCommunityPoster> gameCommunityPosters) {
		super(hListView);
		this.mGameCommunityPosters = gameCommunityPosters;
		mInflater = LayoutInflater.from(context);
	}

	@Override
	public int getCount() {
		if (mGameCommunityPosters == null) {
			return 0;
		}
		return mGameCommunityPosters.size();
	}

	@Override
	public Object getItem(int position) {
		return mGameCommunityPosters.get(position);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		GameCommunityPoster poster = mGameCommunityPosters.get(position);
		holder.iconView.setImageResource(poster.drawableId);
		holder.titleView.setText(poster.titleId);
	...
	public Animator selectedAnimator(View view) {
		...
		AnimatorListener listener = new AnimatorListenerAdapter() {
			...
			public void onAnimationStart(Animator animation) {
				holder.background.setImageResource(R.drawable.corner_yellow_ochre_shape);
			}
		};
