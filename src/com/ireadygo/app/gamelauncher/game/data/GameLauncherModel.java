...
//            return (pm.getActivityInfo(cn, 0) != null);
    ...
    public void addItemToDatabase(Context context, final ItemInfo item, final boolean notify) {
        ...
        int iconWidth = mContext.getResources().getDimensionPixelSize(R.dimen.mygame_app_width);
        int iconHeigth = mContext.getResources().getDimensionPixelSize(R.dimen.mygame_app_height);
