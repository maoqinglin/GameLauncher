...
public final class Utilities {
	...
	private static void initStatics(Context context) {
		...
		// TODO by linmaoqing
		sIconWidth = sIconHeight = (int) resources.getDimension(R.dimen.mygame_app_icon_size);
	...
	public static boolean startActivity(View v, Intent intent, Object tag) {
		...
		try {
			...
			if (useLaunchAnimation) {
				...
				v.getContext().startActivity(intent, opts.toBundle());
			} else {
				SoundPoolManager.instance(v.getContext()).play(SoundPoolManager.SOUND_ENTER);
