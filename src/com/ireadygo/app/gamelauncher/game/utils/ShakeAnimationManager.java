...
public class ShakeAnimationManager {
	...
	class ShakeAnimation {
		...
		void animateShake(final View view) {
			...
			ValueAnimator va = LauncherAnimUtils.ofFloat(-1.0f, 1.0f); //modify by linmaoqing 2014-5-14
			a = va;
		...
		void animateHeartbeatAnim(final View view) {
			...
			ValueAnimator va = LauncherAnimUtils.ofFloat(null); //modify by linmaoqing 2014-5-14
			a = va;
			va.setRepeatMode(ValueAnimator.REVERSE);
			va.setRepeatCount(ValueAnimator.INFINITE);
			va.setDuration(500);
